...
SoftRasterizer::Bounds3::Bounds3(const glm::vec3 &p) : min(p), max(p) {}
...
glm::vec3 SoftRasterizer::Bounds3::diagonal() const { return max - min; }
...
bool SoftRasterizer::Bounds3::overlaps(const Bounds3 &box1,
                                       const Bounds3 &box2) {
...
SoftRasterizer::Bounds3 SoftRasterizer::BoundsUnion(const Bounds3 &box1,
                                                    const Bounds3 &box2) {
  Bounds3 ret;
...
SoftRasterizer::Bounds3 SoftRasterizer::BoundsUnion(const glm::vec3 &point,
                                                    const Bounds3 &box) {
  Bounds3 ret;
