...
//          /*radius=*/0.1f);
//
//diffuse_sphere->getMaterial()->type = SoftRasterizer::MaterialType::DIFFUSE_AND_GLOSSY;
//diffuse_sphere->getMaterial()->color = glm::vec3(0.6f, 0.7f, 0.8f);                  /*Set Diffuse Color*/
