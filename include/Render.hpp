...
namespace SoftRasterizer {
          ...
          public:
                    RenderingPipeline();
                    RenderingPipeline(const std::size_t width,
          ...
          public:
                    ...
                    void loadVertices(const std::vector<Eigen::Vector3f>& vertices) { m_vertices = vertices; }
                    void loadIndices(const std::vector<Eigen::Vector3i>& indices) { m_faces = indices; }
                    void loadColours(const std::vector<Eigen::Vector3f>& colours) { m_colours = colours; }

                    /*set MVP*/
                    void setModelMatrix(const Eigen::Matrix4f& model) { m_model = model; }
                    void setViewMatrix(const Eigen::Matrix4f& view) { m_view = view; }
                    void setProjectionMatrix(const Eigen::Matrix4f& projection) { m_projection = projection; }
          ...
          private:
                    ...
                    void writePixel(const Eigen::Vector3f& point, 
                                              const Eigen::Vector3f& color);

              
                    /*Bresenham algorithm*/
                    void drawLine(const Eigen::Vector3f& p0, 
